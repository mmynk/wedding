...
const ValentinePage = () => {
  ...
  const messages: { [key: number]: { text: string; buttonState?: ButtonState } } = {
    ...
    57: { text: "¿noʎ 'ʍou ǝɯ pɐǝɹ ʇ,uɐɔ ¡ɐH" },
    58: { text: "¿ʇɐɥʍ" },
    59: { text: "˙noʎ ʍoɥs llᴉʍ ʇɐɥʇ llǝM", buttonState: 'default' },
    60: { text: "" },
    ...
    180: { text: "POOF! Both buttons say Yes now.", buttonState: 'both-red' },
    181: { text: "Yeah. I did that." },
    182: { text: "You have no choice now." },
    183: { text: "Just accept it." },
    184: { text: "Because I..." },
    185: { text: "I really..." },
    186: { text: "ZZZzzzzzz" },
    187: { text: "zzzzZZZZzzzz" },
    188: { text: "ZZZZzzzZZZZ" },
    189: { text: "Huh?" },
    190: { text: "Oh! Right!" },
    191: { text: "I really like you." },
    192: { text: "Like, a lot." },
    193: { text: "So please..." },
    194: { text: "Just..." },
    195: { text: "Click..." },
    196: { text: "Yes?" },
    197: { text: "🥺" },
    198: { text: "Pretty please?" },
    199: { text: "I'll stop bothering you if you say Yes." },
    200: { text: "That's a lie." },
    201: { text: "I'll bother you forever." },
    202: { text: "But in a good way." },
    203: { text: "The kind of bothering you'll miss." },
  };
      ...
      case 'both-red':
        return (
          <div className="flex gap-8 items-center">
            ...
            <button onClick={handleNoClick} className={`${baseYesClasses} px-12 py-6 text-4xl opacity-70`}>
              Yes! (But Reluctantly)
            </button>
          </div>
        );
